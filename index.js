...
server.listen(PORT, '0.0.0.0', () => {
    ...
    if (recipes.length === 0) {
        ...
        recipes.push({
            ...
            ingredientes: [
                '400g de spaghetti',
                '200g de panceta o guanciale en cubos',
        ...
        recipes.push({
            ...
            ingredientes: [
                ...
                '1 cucharadita de extracto de vainilla',
                'Aceite en spray para la waflera',
        ...
        recipes.push({
            ...
            ingredientes: [
                '1 kg de muslos de pollo sin hueso, en trozos',
                '2 cebollas medianas finamente picadas',
                '4 dientes de ajo picados',
                '1 trozo de jengibre fresco de 3cm, rallado',
                ...
                '400g de tomates en lata triturados',
